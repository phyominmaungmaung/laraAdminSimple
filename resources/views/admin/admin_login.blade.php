...
@yield('register')
<div id="loginbox">
    <div class="control-group normal_text"><h2>MWD Cafe</h2></div>
    <form id="loginform" class="form-vertical" method="post" action="{{url('admin')}}">{{csrf_field()}}
        ...
        <div class="form-actions">
            <span class="pull-left"><a href="#" class="flip-link btn btn-info" id="to-recover">Forget your password?</a></span>
